...
ALTER TABLE `player` ADD `player_score_before_end` TINYINT NOT NULL DEFAULT '0';
ALTER TABLE `player` ADD `player_score_cards` TINYINT NOT NULL DEFAULT '0';
ALTER TABLE `player` ADD `player_score_board` TINYINT NOT NULL DEFAULT '0';
ALTER TABLE `player` ADD `player_score_after_end` TINYINT NOT NULL DEFAULT '0';
